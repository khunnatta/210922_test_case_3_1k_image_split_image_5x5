...
for i in fileLists:
    ...
    # imgBefore =  cv.imread(r"D:\00_Study\IS\02_code\00_dataset\07_test_red_hue_3\test_input\{}".format(i))
    # imgAfter =  cv.imread(r"D:\00_Study\IS\02_code\00_dataset\07_test_red_hue_3\test_actual\{}".format(i))
...
df = pd.DataFrame(df)
setColName(df).to_csv('210928_1K_img_split_25_blocks_test.csv')